...
G91 G1 X[x / 2 + clearance]                                  ; move to positive X + clearance
...
G91 G1 X-[x + 2 * clearance]                               ; move to negative X + clearance
G91 G38.3 Z-7
%wait
...
G91 G1 Z7                                                     ; move to Z clearance height
G91 G1 X[(x1 - x2) / 2 + clearance] Y[y / 2 + clearance]
...
G91 G1 Z7                                              ; move to Z clearance height
G91 G1 Y-[y + 2 * clearance]                               ; move to negative X + clearance
G91 G38.3 Z-7
%wait
