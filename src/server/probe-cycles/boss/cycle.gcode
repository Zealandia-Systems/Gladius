...
G91 G0 X[dia / 2 + clearance]                                  ; move to positive X + clearance
...
G91 G0 X-[dia + 2 * clearance]                               ; move to negative X + clearance
G91 G0 Z-7 
%wait
...
G91 G0 Z7                                                     ; move to Z clearance height
G91 G0 X[(x1 - x2) / 2 + clearance] Y[dia / 2 + clearance]                                             
...
G91 G0 Z7                                              ; move to Z clearance height
G91 G0 Y-[dia + 2 * clearance]                               ; move to negative X + clearance
G91 G0 Z-7 
%wait
